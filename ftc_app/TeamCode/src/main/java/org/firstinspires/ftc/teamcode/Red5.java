...
@Autonomous(name = "Red5", group = "Autonomous OpMode")

//@Override
public class Red5 extends LinearOpMode {
    /* Declare OpMode members. */

    public static final String TAG = "Red5"; // String for logging
...
//Retract button Pushers
        ...
        waitForStart();
        encoderDrive(HALF_SPEED,  15, 15, 10.0);  // S1: forward 15 Inches with 5 Sec timeout
...
/*        // until we find an image in the camera from vuforia even though it should be there
        while (opModeIsActive() && legos.getRawPose() == null) { //legos are second on the blue side
            //slow down the look so we dont go hyper
            idle();
        }
        ...
        encoderDrive(DRIVE_SPEED,  24, 24, 10.0);  // S3: Reverse 24 Inches with 10 Sec timeout
        encoderDrive(TURN_SPEED,   -turn90degrees, turn90degrees, 4.0);  // S2: Turn left 10 Inches with 4 Sec timeout or 90 degrees
